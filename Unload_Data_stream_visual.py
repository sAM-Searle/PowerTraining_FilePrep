...
def part_change(layer,part):
    ...
    Frametypr = part_group.create_group("Visual")
    return Frametypr
...
def process_frame(executor):
    bin_obj = MultiDatFile(r"D:\MultiplicityExtaStorage\Visual")
    frame_count =0
    layer = 0
    previous_part = 0
    packet_counter = []
    ...
    roi_y = []
    I = []
    with h5py.File(r'D:\MultiplicityExtaStorage\PowerTraining.h5', 'w') as f:
